...
globs: /docs/astro.config, /docs/**/*.md, /docs/**/*.mdx
alwaysApply: false
---
...
- Prefer `.mdx` format if custom components are needed (if Markdown is not enough). Otherwise, use standard `.md`
  format.
- Use astro.js rules for writing documentation pages and organization from `../../web/astro/astro-coding-style.mdc`
- Use typecript rules for writing documentation pages and organization from `../../web/typescript/typescript-coding-style.mdc`
